...
<head>
    ...
    <style>
        ...
        .example-code {
            ...
            padding: 10px;
            border-radius: 5px;
            overflow-x: auto; /* Allows scrolling for long code */
        }
        .patch-section {
            margin-top: 20px;
            padding: 10px;
            border: 1px solid #28a745; /* Green border for patch section */
            border-radius: 5px;
...
header('Location : ' .$page);
        ...
        <div class="example-code"><pre><code>http://exemple.com/index.php?page=../../../../etc/passwd</code></pre>
        </div>
